 ...
 */
   ...
   // picture coordinates for select tool - rg added
      ...
      private int x_Lower_Left;
      private int y_Lower_Left; 	
    
   /** The picture being explored */
      private DigitalPicture picture;
   	
   /** The unaltered picture when the picture is first loaded - Ria added */
   ...
   */
   ...
   //rg added
      private JPanel setUpSideMenu()
      {
         ...
         JButton button_createCollage = new JButton("Create Collage");
         button_createCollage.addActionListener(new Listener_createCollage());
         sub_panel.add(button_createCollage);
   ...
   */
   ...
   //rg added listener for open button
   ...
   */
      ...
      */
      ...
      private class Listener_Posterize implements ActionListener
      {
         public void actionPerformed(ActionEvent e)
         {
         	((Picture)picture).redIt();
				updatePicture();
         }
      }	
   	
      private class Listener_createCollage implements ActionListener
      {
         public void actionPerformed(ActionEvent e)
         {
         	((Picture)picture).createCollage();
				updatePicture();
         }
      }
      ...
      private class Listener_EdgeDetector implements ActionListener
      {
         public void actionPerformed(ActionEvent e)
         {
            ((Picture)picture).edgeDetection(15);
				updatePicture();
         }
      }
   ...
   */
      ...
      {
         Picture pix = new Picture("7inX95in.jpg");
         pix.explore();
      }
   }
